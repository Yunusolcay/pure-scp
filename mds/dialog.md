...
Yukarýdaki örnekte **lorem ipsum** yani ``dtext`` in **x y** deðerleri fonksiyon içinden daha önce atanmýþtýr ve sabittir.  
**radio-checkbox-dtext** için örnekler aynýdýr.
